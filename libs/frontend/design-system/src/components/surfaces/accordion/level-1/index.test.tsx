...
describe('Level 1 Accordion', () => {
  ...
  it('should have both matching title ad content when it is expanded', () => {
    ...
    const header = screen.getByTestId(TEST_IDS.ACCORDION_LEVEL_1_HEADER);
