...
type EnvironmentVariables = SystemEnvironmentVariables | RedisEnvironmentVariables | AwsEnvironmentVariables;

export function validateEnvConfig(config: Record<string, unknown>) {
  const allEnvironmentVariables = [SystemEnvironmentVariables, RedisEnvironmentVariables, AwsEnvironmentVariables];
