...
export class HttpAgentConfigService {
  ...
  get httpAgentMaxSockets() {
    return this.configService.get('HTTP_AGENT_MAX_SOCKETS', { infer: true })!;
  }

  get httpAgentMaxFreeSockets() {
    return this.configService.get('HTTP_AGENT_MAX_FREE_SOCKETS', { infer: true })!;
  }

  get httpAgentSocketTimeout() {
    return this.configService.get('HTTP_AGENT_SOCKET_TIMEOUT', { infer: true })!;
  }

  get httpAgentFreeSocketTimeout() {
    return this.configService.get('HTTP_AGENT_FREE_SOCKET_TIMEOUT', { infer: true })!;
  }
...
export class HttpAgentEnvironmentVariables {
  ...
  @Expose()
  @IsNumber()
  HTTP_AGENT_MAX_SOCKETS: number;

  @Transform(numberTransformer)
  @Expose()
  @IsNumber()
  HTTP_AGENT_MAX_FREE_SOCKETS: number;

  @Transform(numberTransformer)
  @Expose()
  @IsNumber()
  HTTP_AGENT_SOCKET_TIMEOUT: number;

  @Transform(numberTransformer)
  @Expose()
  @IsNumber()
  HTTP_AGENT_FREE_SOCKET_TIMEOUT: number;
