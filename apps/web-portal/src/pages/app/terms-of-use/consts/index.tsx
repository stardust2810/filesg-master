...
export const termsOfUseListContent: ListContent[] = [
  {
    title: 'General',
    content: [
      <>
        These Terms of Use govern your access to and use of our services, including the application (whether as software or as a website or
        otherwise), its contents (including APIs, if any), push notifications and all other accompanying materials as identified in the{' '}
        <TextLink font="PARAGRAPH" type="LINK" to={`${WebPage.TERMS_OF_USE}#schedule`}>
          Schedule
        </TextLink>{' '}
        below (collectively, the "<Bold type="FULL">Service</Bold>”).
      </>,
      <>
        This Service is provided to you by the Government Technology Agency ("<Bold type="FULL">GovTech</Bold>"). GovTech’s office is
        located at 10 Pasir Panjang Road, #10-01, Mapletree Business City, Singapore 117438.
      </>,
      <>
        By accessing or using any part of this Service, you unconditionally agree and accept to be legally bound by these Terms of Use and
        any amendments thereto from time to time. GovTech reserves the right to change these Terms of Use at its sole discretion and at any
        time.{' '}
        <Bold type="FULL">
          You should read the Terms of Use carefully each time you access or use any part of this Service as such access or use will
          constitute your agreement to the Terms of Use and any amendments to it.
        </Bold>
      </>,
      <Bold type="FULL">If you do not agree to these Terms of Use, please do not use this Service or any part of this Service.</Bold>,
      'If you are accessing or using the Service for and on behalf of another entity (such as your employer), you warrant and represent that you have the necessary authority to bind such entity to these Terms of Use.',
    ],
  },
  {
    ...
    content: (
      <>
        ...
        &nbsp;for more information and terms concerning this Service.
      </>
    ),
  },
  {
    title: 'Licence Terms and Restrictions',
    content: [
  ...
  },
  {
    ...
    content: [
      <>
        ...
        <Bold type="FULL">Third Party”</Bold>). In such an event, there may be terms of use of the third party software or service (the “
        <Bold type="FULL">Third Party Terms</Bold>”). GovTech may be required under or as a result of the Third Party Terms to notify you of
        certain terms that apply to you (either directly as an end user, or as a party whose acts or omissions could cause GovTech to breach
        the Third Party Terms) when you use the Services. An example of Third Party Terms may be open source software terms or standard form
        terms of the distribution platform from which you obtain any part of the Service (e.g. Google Play Store or Apple App Store terms)
        which bind GovTech as a developer or user of the distribution platform (the “<Bold type="FULL">Distribution Terms</Bold>”).
        Information on the Third Party Terms are embedded in the Service, already accounted for in these Terms of Use, publicly available
        (e.g the Distribution Terms) or otherwise listed in the{' '}
        <TextLink font="PARAGRAPH" type="LINK" to={`${WebPage.TERMS_OF_USE}#schedule`}>
          Schedule
        </TextLink>{' '}
        herein. For the avoidance of doubt, insofar as this Clause 4 relates to the Distribution Terms, the relevant Distribution Terms are
        the terms of the specific platform from which you obtained a copy of the software or application that is part of the Service. For
        example, if you obtained the said copy from the Google Play Store, then the relevant terms are Google’s Distribution Terms.
      </>,

      <>
        <Bold type="FULL">
          It is your responsibility to check and read the most up-to-date versions of these Third Party Terms and you are deemed to have
          notice of the same.
        </Bold>{' '}
        In particular, you are deemed to have notice of the Third Party Terms that GovTech (under the Third Party Terms) is required to
        notify you, and you unconditionally agree to be bound by all the obligations in the Third Party Terms which are applicable to you
        (whether as end user, or as a party whose acts or omissions could cause GovTech to breach the Third Party Terms, or otherwise). For
        the avoidance of doubt, where Third Party Terms are listed, such Third Party Terms shall be deemed to include any privacy policies
        and acceptable use policies as are applicable to you.
      </>,
  ...
  {
    title: 'Your Consent to Your Data and to Access Functions of Your Device',
    content: [
  ...
  {
    isSameLevelSubsection: true,
    title: 'Ownership of Feedback / Requests / Suggestions',
    content:
  ...
  },
  {
    ...
    content: [
      <>
        If you receive information or data (in whatever form) from GovTech or a Third Party which is designated confidential or proprietary
        or is otherwise reasonably understood to be confidential or proprietary (collectively, “
        <Bold type="FULL">Confidential Information</Bold>”), you shall not use, disclose or reproduce the Confidential Information except
        for the purpose for which it was provided to you. If consent to disclose the Confidential Information to a third party is given by
        GovTech or the Third Party to you, any act or omission in respect of the Confidential Information by that person shall be deemed to
        be your act or omission and you agree to be fully liable for the same. In all cases, you shall protect the Confidential Information
        to the same extent you protect your own confidential information but in no event less than a reasonable standard of care. You shall
        ensure that any recipients are bound by confidentiality terms at least as restrictive as this Clause.
      </>,
  ...
  {
    title: 'Disclaimers and Indemnity',
    content: [
      {
        title: (
          <Bold type="FULL">
            The Service is provided on an "as is" and “as available” basis without warranties of any kind. To the fullest extent permitted
            by law, GovTech does not make any representations or warranties of any kind whatsoever in relation to the Service and hereby
            disclaims all express, implied and/or statutory warranties of any kind to you or any third party, whether arising from usage or
            custom or trade or by operation of law or otherwise, including but not limited to any representations or warranties:
          </Bold>
        ),

        content: [
          <Bold type="FULL">
            as to the accuracy, completeness, correctness, currency, timeliness, reliability, availability, interoperability, security,
            non-infringement, title, merchantability, quality or fitness for any particular purpose of the Service; and/or
          </Bold>,
          <Bold type="FULL">
            that the Service or any functions associated therewith will be uninterrupted or error-free, or that defects will be corrected or
            that this Service, website and the server are and will be free of all viruses and/or other malicious, destructive or corrupting
      ...
      },
      {
        title: (
          <Bold type="FULL">
            GovTech shall also not be liable to you or any third party for any damage or loss of any kind whatsoever and howsoever caused,
            including but not limited to any direct or indirect, special or consequential damages, loss of income, revenue or profits, lost
            or damaged data, or damage to your computer, software or any other property, whether or not arising directly or indirectly from
            –
          </Bold>
        ),
        content: [
          <Bold type="FULL">your access to or use of this Service, or any part thereof;</Bold>,

          <Bold type="FULL">any loss of access or use of this Service or any part of this Service, howsoever caused;</Bold>,

          <Bold type="FULL">any inaccuracy or incompleteness in, or errors or omissions in the transmission of, the Service;</Bold>,

          <Bold type="FULL">
            any delay or interruption in the transmission of the Service, whether caused by delay or interruption in transmission over the
            internet or otherwise; or
          </Bold>,

          <Bold type="FULL">any decision made or action taken by you or any third party in reliance upon the Service,</Bold>,
          {
            content: <Bold type="FULL">regardless of whether GovTech has been advised of the possibility of such damage or loss.</Bold>,
          },
        ],
      },

      <Bold type="FULL">
        Without prejudice and in addition to the foregoing, insofar as the Service facilitates or requires the provision, use or functioning
        of, or is provided in conjunction with, other products, software, materials and/or services not provided by GovTech, GovTech makes
        no representation or warranty in relation to such products, software, materials and/or services (including without limitation any
        representation or warranties as to timeliness, reliability, availability, interoperability, quality, fitness for purpose,
      ...
      <Bold type="FULL">
        You agree to defend and indemnify and keep GovTech and its officers, employees, agents and contractors harmless against all
        liabilities, losses, damages, costs or expenses (including legal costs on an indemnity basis) howsoever arising out of or in
        connection with your access or use of the Service (including third party software or services) or your non-compliance with the Terms
        of Use, Third Party Terms or Incorporated Terms, whether or not you had been advised or informed of the nature or extent of such
        liabilities, losses, damages, costs or expenses. You warrant and represent that your access or use of the Service does not and will
        not breach or violate any laws, regulations, trade, economic and/or export sanctions (wherever in the world) applicable to you, and
        that you shall not transmit any malicious code, illegal, infringing or undesirable content or materials to GovTech or its agents or
        any Third Party.
      </Bold>,
      ...
      {
        title: 'Without prejudice and in addition to GovTech’s other rights:',
        content: [
  ...
  },
  {
    ...
    content: [
      ...
      {
        title: 'GovTech reserves all rights',
        content: [
  ...
  },
  {
    ...
    content: [
      ...
      'Subject to clause 11.3, any dispute arising out of or in connection with these Terms of Use, including any question regarding its existence, validity or termination, shall be referred to and finally resolved in the Courts of the Republic of Singapore and the parties hereby submit to the exclusive jurisdiction of the Courts of the Republic of Singapore.',
      {
        title: (
          <>
            GovTech may, at its sole discretion, refer any dispute referred to in clause 11.2 above to arbitration administered by the
            Singapore International Arbitration Centre (“<Bold type="FULL">SIAC</Bold>”) in Singapore in accordance with the Arbitration
            Rules of the SIAC ("<Bold type="FULL">SIAC Rules</Bold>") for the time being in force, which rules are deemed to be incorporated
            by reference in this clause. Further:{' '}
          </>
        ),
        content: [
...
export const termsOfUseSchedule: ListContent[] = [
  {
    title: (
  ...
  },
  {
    ...
    content: [
      'FileSG facilitates the issuance, storage and retrieval of digital documents issued by the Singapore Government (including its ministries, departments, and organs of state) and/or public sector agencies, to member(s) of the public.',

      'GovTech is not responsible for the digital documents themselves. Your use of the digital documents may be governed by separate terms with the respective issuing Government agency or public sector agency.',

      'Any queries or issues concerning the use, content or information of/in the digital document(s) (such as errors) should be directed to the respective issuing Government agency or public sector agency.',
    ],
  },
  {
    title: 'Special Terms',
    content: [
      'GovTech has the right to remove and/or delete all or any of the digital documents stored on the Service at any time either upon request of the issuing Government agency or public sector agency, or after the date falling 5 years from the date of your last activity.',
    ],
  },
];
