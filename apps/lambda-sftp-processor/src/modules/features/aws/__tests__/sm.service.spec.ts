...
import { mockBaseSmService, mockKey } from '../__mocks__/aws-sm.service.mock';
...
describe('SmService', () => {
  ...
  describe('getSecretValue', () => {
    ...
    it('SMGetSecretException should be thrown if key cannot be found', async () => {
      ...
      await expect(service.getSecretValue(mockKey)).rejects.toThrowError(SMGetSecretException);
    });
  });
});
