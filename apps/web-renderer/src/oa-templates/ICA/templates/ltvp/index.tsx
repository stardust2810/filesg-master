...
export const LtvpTemplate = ({ document, wrappedDocument, className = '' }: Props) => {
  ...
  useEffect(() => {
    if (error) {
      const message: RendererErrorMessage = {
  ...
  }, [hasVerificationResultAndIsOverallInvalid, retrieveIcaPhoto, verificationResult, wrappedDocument]);
