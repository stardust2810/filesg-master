...
import { FormSGEnvironmentVariables } from './formsg-config.service';
import { SystemEnvironmentVariables } from './system-config.service';

type EnvironmentVariables = SystemEnvironmentVariables | AWSEnvironmentVariables | AuthEnvironmentVariables | FormSGEnvironmentVariables;
