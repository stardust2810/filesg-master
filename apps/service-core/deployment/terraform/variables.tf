...
variable "event_logs_eks_pod_name" {
  description = "Name of the event logs service"
  type        = string
  default = "backend-event-logs"
}

variable "event_logs_eks_pod_port" {
  description = "Port of event logs service"
  type        = string
  default = "3000"
}
