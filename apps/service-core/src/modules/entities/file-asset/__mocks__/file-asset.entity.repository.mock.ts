...
export const mockFileAssetEntityRepository: MockRepository<FileAssetEntityRepository> = {
  ...
  findAndCountRecentViewableFileAssets: jest.fn(),
  findViewableFileAssetsByStatusAndCorporateUen: jest.fn(),
  findDownloadableFileAssetsByUuidsAndUserUuid: jest.fn(),
  findAccessibleFileAssetByUuidAndUserId: jest.fn(),
  ...
  findFileAssetUsingFileAssetUuidAndUserId: jest.fn(),
  findAgencyFileAssetByRecipientFileAssetUuidAndEserviceUserUuid: jest.fn(),
  findCorppassFileAssetByUuidAndUserId: jest.fn(),
  findAndCountCorporateViewableFileAssets: jest.fn(),
};
